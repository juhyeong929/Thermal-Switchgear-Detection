...
> 자동 생성 · 2026-09-03 · 정의 원본은 `schemas/classes_v2.py`
...
| `UNKNOWN` | 근거 없음 — 확정하지 않는다. 라벨러에게 배포하지 않는다 | 6종 | **UNKNOWN** |

**확정 19/25 클래스.** 미확정 6종은 라벨러에게 배포하지 않는다 —
...
| 27 | ACB 접촉부 | `UNKNOWN` | **UNKNOWN** | 정본·참고 모두 라벨 실적 0건 (NQ-13 · DEC-030) |
