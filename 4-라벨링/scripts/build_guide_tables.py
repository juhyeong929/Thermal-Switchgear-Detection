...
| 9 | **VCB 접촉부가 새로 배포됩니다** (P6 3종→4종 · P7 1종→2종) | v1 에서는 세는 단위가 정해지지 않아 뺐습니다. 기존 라벨 표본 15장을 열어 접속점 단위로 그려져 있음을 확인했습니다 | DEC-024 · `vcb_contact_review.csv` |
| 10 | **'분기 접촉부' 가 없어지고 '케이블헤드' 로 통일됐습니다** (PF&PT반) | 발주처 가이드 개정입니다. 이전 판은 VCB반만 케이블헤드로 부르고 PF&PT반은 분기 접촉부로 불렀습니다 | 새 가이드 PDF p14 · DEC-025 |
| 11 | **헷갈리는 세 쌍(LA↔SA · SA↔케이블헤드)과 접촉부 보류 규칙을 §7 에 적었습니다** | 가이드가 직접 주의를 준 항목인데 지침서에 옮겨져 있지 않았습니다 | 새 가이드 PDF p8·p14·p16·p17 |
